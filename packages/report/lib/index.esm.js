...
var Report = /** @class */ (function () {
    ...
    Report.prototype.request = function (data) {
    ...
    Report.prototype.getAssetPath = function (compilation, name) {
        return require$$1$1.join(compilation.getPath(compilation.compiler.outputPath), name.split("?")[0]);
    };
    ...
    Report.prototype.uploadFile = function (_a) {
        var filePath = _a.filePath, name = _a.name;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        content = require$$6.createReadStream(filePath);
                        formData.set(name, content);
                        return [4 /*yield*/, this.request(formData)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
